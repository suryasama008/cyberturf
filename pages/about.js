                  ...
                  <div className='py-12'>
                    <div className='max-w-lg lg:max-w-md mx-auto lg:mx-0 mb-8 text-center lg:text-left'>
                      ...
                      <p className='text-blueGray-400 leading-relaxed wow animate__animatedanimated animate__fadeIn'>
                        We are{' '}
                        <strong className='text-blue-500'>Cyber Turf</strong>, a
                        Creative Design{' '}
                        <span
              ...
              <div className='flex flex-wrap items-center justify-between max-w-2xl lg:max-w-full mb-12'>
                ...
                <div className='w-full lg:w-1/2'>
                  <p className='text-blueGray-400 leading-loose wow animate__animatedanimated animate__fadeIn'>
                    Our team has industry experience in Web development, Java
                    and other Object oriented languages. We are highly skilled
                    in cloud, containerization(Docker) and latest tech like
                    elasticsearch and Graph DB. We are your one stop shop for
                    Data needs like Machine Learning and Visualizations and even
                    maintainance of all kinds of Data jobs.
                  </p>
                </div>
              </div>
                ...
                >
                  <div className='p-12 bg-white shadow rounded'>
                    ...
                    <p className='text-sm text-blueGray-400 leading-relaxed'>
                      ...
                      in cloud, containerization(Docker) and latest tech like
                      elasticsearch and Graph DB. We are your one stop shop for
                      Data needs like Machine Learning and Visualizations and
                      even maintainance of all kinds of Data jobs.
                    </p>
                  </div>
                </div>
                <div
            ...
            <div className='container text-center'>
              <div className='max-w-lg mx-auto mb-16'>
                ...
                <p className='text-blueGray-400 leading-loose'>
                  ...
                  help to manage business categories
                </p>
              </div>
              ...
              <div className='max-w-2xl mx-auto text-center'>
                <div className='max-w-md mb-8 mx-auto'>
                  ...
                  <h2
                    ...
                    data-wow-delay='.s'
                  >
                    We will <span className='text-blue-500'>be glad</span> to
                    hear from you!
                  </h2>
                </div>
                <div>
                        ...
                        <div className="relative flex flex-wrap -mx-4">
                            <div className="w-full lg:w-1/2 pt-20 px-4 max-w-lg lg:max-w-full mx-auto lg:mx-0 text-center lg:text-left">
                                <Link href="/"><a className="inline-block mx-auto lg:ml-0 text-3xl font-semibold leading-none wow animate__animatedanimated animate__fadeIn animated" data-wow-delay=".1s">
                                    <img className="h-10" src="/assets/imgs/logos/Cyber Turf-logo.svg" alt="Cyber Turf" />
                                </a></Link>
