            ...
            <div className='flex flex-wrap mb-12 lg:mb-20 -mx-3 text-center lg:text-left'>
              <div className='w-full lg:w-1/5 px-3 mb-6 lg:mb-0'>
                <Link href='/'>
                  <a className='inline-block mx-auto lg:mx-0 text-3xl font-semibold leading-none'>
                    <img
                      className='h-10'
                      src='/assets/imgs/logos/Cyber Turf-logo.svg'
                      alt='Cyber Turf'
                    />
                  </a>
                </Link>
              ...
              <div className='w-full lg:w-2/5 px-3 mb-8 lg:mb-0'>
                <p className='max-w-md mx-auto lg:max-w-full lg:mx-0 lg:pr-32 lg:text-lg text-blueGray-400 leading-relaxed'>
                  Helping you <strong>maximize</strong> operations management
                  with digitization
                </p>
              </div>
              <div className='w-full lg:w-1/5 px-3 mb-8 lg:mb-0'>
                ...
                <p className='lg:text-lg text-blueGray-400'>
                  92 Ravenscroft Rd, Ajax, ON L1T 1X2
                </p>
              </div>
              <div className='w-full lg:w-1/5 px-3'>
                ...
                <p className='lg:text-lg text-blueGray-400'>(+1) 647-267-4302</p>
                <p className='lg:text-lg text-blueGray-400'>
                  info@cyberturfsolutions.com
                </p>
              </div>
            </div>
